                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <Text style={[styles.tableCell, styles.col3]}>
                            {businessDetails.currency} {(transactionData.breakdown?.basePrice || transactionData.amount).toFixed(2)}
                        </Text>
                    </View>

                    {/* 2. Registration Fee Row (if any) */}
                    {transactionData.breakdown?.registrationFee > 0 && (
                        <View style={styles.tableRow}>
                            <Text style={[styles.tableCell, styles.col1]}>Registration Fee</Text>
                            <Text style={[styles.tableCell, styles.col2]}>1</Text>
                            <Text style={[styles.tableCell, styles.col3]}>
                                {businessDetails.currency} {transactionData.breakdown.registrationFee.toFixed(2)}
                            </Text>
                        </View>
                    )}
                    ...
                    {transactionData.breakdown?.discounts?.length > 0 && transactionData.breakdown.discounts.map((discount, index) => (
                        <View style={styles.tableRow} key={index}>
                            ...
                            <Text style={[styles.tableCell, styles.col2]}>1</Text>
                            <Text style={[styles.tableCell, styles.col3, { color: '#d32f2f' }]}>
                                - {businessDetails.currency} {discount.amount.toFixed(2)}
                            </Text>
                        </View>
                    ))}
                </View>
